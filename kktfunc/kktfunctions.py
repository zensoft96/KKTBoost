...
class Kassa():
    ...
    # fptr.cancelMarkingCodeValidation()
        ...
        for good in goods:
            ...
            driver.setParam(2108, 0) # У нас всегда Штуки(0)
    ...
    def openShift(self, cashier: json):
        ...
        elif driver.errorDescription().find('Смена открыта') != -1:
            return self.creturnDict(True,{}, f'Ошибка при открытии смены {driver.errorDescription()}')
        else:
